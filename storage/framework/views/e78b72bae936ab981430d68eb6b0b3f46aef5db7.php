...
<?php $__env->startSection('content'); ?>
	<div class="card">
		...
		<div class="card-body">
			<form action="<?php echo e(url('/chitietsp/them')); ?>" method="post">
				<?php echo csrf_field(); ?>

				
				<div class="form-group">
					<label for="sanpham_id">Tên sản phẩm</label>
					<input type="text" class="form-control <?php $__errorArgs = ['sanpham_id'];
...
unset($__errorArgs, $__bag); ?>" id="sanpham_id" name="sanpham_id" value="<?php echo e($sanpham->id); ?>" />
					<?php $__errorArgs = ['sanpham_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
