...
@section('content')
	<div class="card">
		...
		<div class="card-body">
			<form action="{{ url('/chitietsp/them') }}" method="post">
				@csrf

				
				<div class="form-group">
					<label for="sanpham_id">Tên sản phẩm</label>
					<input type="text" class="form-control @error('sanpham_id') is-invalid @enderror" id="sanpham_id" name="sanpham_id" value="{{ $sanpham->id }}" />
					@error('sanpham_id')
